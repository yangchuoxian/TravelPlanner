...
module.exports.csrf = {
   ...
   origin: '',
   routesDisabled: '/mobile/submit_login, ' +
   '/mobile/logout, ' +
   '/mobile/delete_user, ' +
   '/mobile/update_user_role, ' +
   '/mobile/update_user, ' +
   '/mobile/upload_user_avatar, ' +
   '/mobile/submit_new_user, ' +
   '/mobile/change_user_password, ' + 
   '/mobile/change_schedule, ' +
   '/mobile/delete_user_schedule, ' + 
   '/mobile/create_new_schedule' 
};